...
public class CategoryList extends JFrame {
	...
	CategoryBusiness objCtg = new CategoryBusiness();
	...
	private void loadData() {
		/* List<List<Object>> categories = objCtg.readCategories();
		for (List<Object> category : categories) {
			tableModel.addRow(new Object[]{category.get(0), category.get(1)});
		} */
	}
